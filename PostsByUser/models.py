...
class Save_Post(models.Model):
    user = models.ForeignKey(User,on_delete=models.CASCADE,related_name='post_saver')
    user2 = models.ForeignKey(User, on_delete=models.CASCADE,related_name='post_owner')
